...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'asdby12nsaczx1512'
...
#엔드포인트명을 지정하지 않으면 `함수명`이 엔드포인트 명이 된다
...
"""템플릿 엔진이란:
웹 서버 프레임워크 중에서는 사용자에게 문서를 전달할 때,
빈 칸이 있는 HTML 문서와 그 빈칸에 들어갈 데이터를 함께 전달해주도록
설계된 경우가 많다."""
...
with app.test_request_context():
  ...
  print(url_for("show_name", name="AK", page="1"))# /name/AK?page=1
